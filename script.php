...
try {
  ...
  $mail->Username   = 'd310d179e8b8d3';                     //SMTP username
  $mail->Password   = '2fb18b74a7b93e';                               //SMTP password
  ...
  $mail->Subject = 'auth cridentials p12';
  $mail->Body    = 'your p12 file is shown below';
